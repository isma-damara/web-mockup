...
import { InstagramFeed, CatalogFooter } from "../components/CatalogSections";
  ...
  return (
    <div className="min-h-screen bg-rose-50/30 font-sans">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="mt-2 text-sm text-slate-600">Inspirasi gaya dan produk terbaru di feed kami.</p>
      </section>
      <InstagramFeed />
      <CatalogFooter />
    </div>
