...
import { BlogSection, CatalogFooter } from "../components/CatalogSections";
  ...
  return (
    <div className="min-h-screen bg-rose-50/30 font-sans">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-3xl font-bold text-slate-900">Beauty Tips</h1>
        <p className="mt-2 text-sm text-slate-600">Artikel singkat seputar perawatan dan kecantikan.</p>
      </section>
      <BlogSection />
      <CatalogFooter />
    </div>
